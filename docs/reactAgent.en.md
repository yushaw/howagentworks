# GeneralAgent Complete Lifecycle Flow Diagram

> This document provides a detailed description of the complete lifecycle of generalAgent from startup to execution, including all core mechanisms, external dependencies, and code location references.
...
- [LangGraph Execution Loop](#langgraph-execution-loop)
- [Core Mechanisms Deep Dive](#core-mechanisms-deep-dive)
  - [MCP Integration](#mcp-integration)
  - [delegate_task Delegation](#delegate_task-delegation)
  - [Agent Handoff](#agent-handoff)
  - [Document Indexing and Search](#document-indexing-and-search)
  - [Automatic Context Compression](#automatic-context-compression)
  - [HITL Mechanism](#hitl-mechanism)
- [Core Tool Implementation](#core-tool-implementation)
- [External Dependencies List](#external-dependencies-list)
...
```
main.py → generalAgent/main.py:main()
                ↓
        generalAgent/main.py:async_main()
```
